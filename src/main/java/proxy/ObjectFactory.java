...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://ws.tp1.org/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.tp1.org/", "ConvertResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.tp1.org/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://ws.tp1.org/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.tp1.org/", "getCompteResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.tp1.org/", "listComptes");
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.tp1.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.tp1.org/", name = "listComptesResponse")
