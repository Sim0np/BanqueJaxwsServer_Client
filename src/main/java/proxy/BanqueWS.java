 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.tp1.org/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.tp1.org/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.tp1.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.tp1.org/", "BanqueServicePort"), BanqueService.class, features);
    }
